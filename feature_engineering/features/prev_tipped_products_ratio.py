...
class PrevTippedProductsRatio(StaticFeature):
    ...
    def prev_tipped_products_ratio_calculation(user_orders):
    ...
    def _compute_feature(self):
        ...
        self.orders_tip = pd.merge(self.orders_tip, grouped[['user_id', 'order_number', 'prev_tipped_products_ratio']],
