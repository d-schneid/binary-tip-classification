...
class ProductCardOrder(Analysis):
    ...
    def _plot_cross_tab(self, product_card_order_tip_rate, product_tip_standard_deviation):
        ...
        sns.boxplot(data=tip_probability_per_bin, x='binned_normalized_add_to_cart_order', y='tip', ax=ax1)
        ax1.set_xlabel('Normalized Add to Cart Order')
        ax1.set_ylabel('Distribution of Tip Probabilities')
        ax1.set_title('Tip Probability Distribution by Normalized Add to Cart Order')
